...
angular.module('bootstrapLightbox').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('lightbox.html',
    ...
    "<a class=\"btn btn-xs btn-default leftSlideArrow\" ng-click=Lightbox.prevImage()> <span></span><span></span> </a> " +
    "<a ng-href={{Lightbox.imageUrl}} target=_blank class=\"btn btn-xs btn-default changeBackBGColor\" title=\"Open in new tab\">Open image in new tab</a> " +
    "<a class=\"btn btn-xs btn-default rightSlideArrow\" ng-click=Lightbox.nextImage()> <span></span><span></span> </a>" +
    "</div></div>" +
    ...
    "<a ng-href={{Lightbox.imageUrl}}>Watch video</a></embed-video></div></div></div>"
  );
